...
class OurNeuralNetwork():
    ...
    *** DISCLAIMER ***
    ...
    def train(self, data, all_y_trues):
        ...
        """
        learn_rate = 0.1
        epochs = 800  # number of times to loop through the entire dataset
...
emily = np.array([-2, -1])
frank = np.array([25, 6])
emily1 = np.array([17, 4])
frank1 = np.array([-15, -6])
print("Emily: %.3f" % network.feedforward(emily))
print("Frank: %.3f" % network.feedforward(frank))
print("Emily1: %.3f" % network.feedforward(emily1))
print("Frank1: %.3f" % network.feedforward(frank1))
